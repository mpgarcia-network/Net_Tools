...
T: dict[str, dict[str, str]] = {
    ...
    "bk.not_linked": {"pt": "Device não vinculado ao rConfig (sem external_id) — rode o sync do rConfig.", "en": "Device not linked to rConfig (no external_id) — run the rConfig sync.", "es": "Dispositivo no vinculado a rConfig (sin external_id) — ejecute la sincronización."},
