...
T: dict[str, dict[str, str]] = {
    ...
    "account.tokens": {"pt": "Tokens de API", "en": "API tokens", "es": "Tokens de API"},
    "account.tokens_help": {
        "pt": "Tokens autenticam integrações via header Authorization: Bearer <token>. O token herda seu papel e a alçada por camada.",
        "en": "Tokens authenticate integrations via the Authorization: Bearer <token> header. The token inherits your role and per-layer clearance.",
        "es": "Los tokens autentican integraciones vía el header Authorization: Bearer <token>. El token hereda su rol y la autorización por capa.",
    },
    "account.token_once": {
        "pt": "Copie agora — este token não será exibido novamente:",
        "en": "Copy it now — this token won't be shown again:",
        "es": "Cópielo ahora — este token no se mostrará de nuevo:",
    },
    "account.token_name": {"pt": "Nome do token", "en": "Token name", "es": "Nombre del token"},
    "account.token_create": {"pt": "Gerar token", "en": "Generate token", "es": "Generar token"},
    "account.token_name_col": {"pt": "Nome", "en": "Name", "es": "Nombre"},
    "account.token_prefix": {"pt": "Prefixo", "en": "Prefix", "es": "Prefijo"},
    "account.token_role": {"pt": "Papel", "en": "Role", "es": "Rol"},
    "account.token_last_used": {"pt": "Último uso", "en": "Last used", "es": "Último uso"},
    "account.token_never": {"pt": "nunca", "en": "never", "es": "nunca"},
    "account.token_revoke": {"pt": "Revogar", "en": "Revoke", "es": "Revocar"},
    "account.token_confirm": {
        "pt": "Revogar este token? Integrações que o usam deixarão de funcionar.",
        "en": "Revoke this token? Integrations using it will stop working.",
        "es": "¿Revocar este token? Las integraciones que lo usan dejarán de funcionar.",
    },
    "account.token_none": {"pt": "Nenhum token criado.", "en": "No tokens yet.", "es": "Ningún token creado."},
    ...
    "c.version": {"pt": "Versão", "en": "Version", "es": "Versión"},
    ...
    "df.pre_commands": {"pt": "Pré-comandos (antes da config)", "en": "Pre-commands (before config)", "es": "Precomandos (antes de la config)"},
    "df.maintenance_password": {"pt": "Senha de manutenção (_cmdline)", "en": "Maintenance password (_cmdline)", "es": "Contraseña de mantenimiento (_cmdline)"},
    "df.discover_maint": {"pt": "Descobrir senha", "en": "Discover password", "es": "Descubrir contraseña"},
    ...
    "mf.vars_manage": {"pt": "Gerenciar parâmetros de rede", "en": "Manage network parameters", "es": "Gestionar parámetros de red"},
    ...
    "rd.save_config": {"pt": "Salvar config", "en": "Save config", "es": "Guardar config"},
    "rd.save_config_hint": {"pt": "Salva a configuração em execução na inicialização (persistência). Só nos devices com sucesso.", "en": "Saves the running config to startup (persistence). Only on successful devices.", "es": "Guarda la configuración en ejecución en el arranque (persistencia). Solo en dispositivos con éxito."},
    "rd.saved_ok": {"pt": "Config salva em {n} device(s).", "en": "Config saved on {n} device(s).", "es": "Config guardada en {n} dispositivo(s)."},
    "rd.saved_failed": {"pt": "Falha ao salvar em: {names}.", "en": "Failed to save on: {names}.", "es": "Fallo al guardar en: {names}."},
    "rd.saved_skipped": {"pt": "Não salvos (sem sucesso): {names}.", "en": "Not saved (not successful): {names}.", "es": "No guardados (sin éxito): {names}."},
    "rd.save_now": {"pt": "Salvar agora", "en": "Save now", "es": "Guardar ahora"},
    ...
    "uf.email": {"pt": "E-mail (notificações)", "en": "Email (notifications)", "es": "Correo (notificaciones)"},
    ...
    "set.pre_commands_title": {"pt": "Pré-comandos globais", "en": "Global pre-commands", "es": "Precomandos globales"},
    ...
    "prm.title": {"pt": "Parâmetros de rede", "en": "Network parameters", "es": "Parámetros de red"},
    "prm.subtitle": {"pt": "Defina os campos uma vez e preencha os valores (global e por site). No modelo, use {{ var.chave }}.", "en": "Define the fields once and fill the values (global and per site). In the template, use {{ var.key }}.", "es": "Defina los campos una vez y complete los valores (global y por sitio). En la plantilla, use {{ var.clave }}."},
    "prm.fields_title": {"pt": "Campos", "en": "Fields", "es": "Campos"},
    "prm.fields_hint": {"pt": "Nomes das variáveis usadas nos modelos (ex.: ntp, rota_default, vlan_dhcp).", "en": "Names of the variables used in templates (e.g.: ntp, default_route, dhcp_vlan).", "es": "Nombres de las variables usadas en las plantillas (ej.: ntp, ruta_default, vlan_dhcp)."},
    "prm.field_key": {"pt": "Chave", "en": "Key", "es": "Clave"},
    "prm.field_desc": {"pt": "Descrição", "en": "Description", "es": "Descripción"},
    "prm.field_desc_ph": {"pt": "ex.: servidor NTP", "en": "e.g.: NTP server", "es": "ej.: servidor NTP"},
    "prm.field_add": {"pt": "Adicionar campo", "en": "Add field", "es": "Agregar campo"},
    "prm.field_remove": {"pt": "remover", "en": "remove", "es": "eliminar"},
    "prm.none_fields": {"pt": "Nenhum campo definido ainda.", "en": "No fields defined yet.", "es": "Ningún campo definido aún."},
    "prm.globals_title": {"pt": "Valores globais", "en": "Global values", "es": "Valores globales"},
    "prm.globals_hint": {"pt": "Valem para todos os devices (o site pode sobrescrever).", "en": "Apply to all devices (site can override).", "es": "Valen para todos los dispositivos (el sitio puede sobrescribir)."},
    "prm.globals_save": {"pt": "Salvar globais", "en": "Save globals", "es": "Guardar globales"},
    "prm.sites_title": {"pt": "Valores por site", "en": "Values per site", "es": "Valores por sitio"},
    "prm.sites_hint": {"pt": "Sobrescrevem o global para os devices daquele site. Vazio = usa o global.", "en": "Override the global for devices of that site. Empty = use the global.", "es": "Sobrescriben el global para los dispositivos de ese sitio. Vacío = usa el global."},
    "prm.site_pick": {"pt": "Escolher site", "en": "Pick site", "es": "Elegir sitio"},
    "prm.site_open": {"pt": "Abrir", "en": "Open", "es": "Abrir"},
    "prm.site_name": {"pt": "Site (nome exato do device)", "en": "Site (exact device name)", "es": "Sitio (nombre exacto del dispositivo)"},
    "prm.uses_global": {"pt": "vazio = usa o global", "en": "empty = use global", "es": "vacío = usa el global"},
    "prm.site_save": {"pt": "Salvar site", "en": "Save site", "es": "Guardar sitio"},
    "prm.site_remove": {"pt": "remover site", "en": "remove site", "es": "eliminar sitio"},
    "set.templates_title": {"pt": "Parâmetros de rede", "en": "Network parameters", "es": "Parámetros de red"},
    "set.templates_open": {"pt": "Abrir Parâmetros", "en": "Open Parameters", "es": "Abrir Parámetros"},
    ...
    "set.ldap_mode_ldap": {"pt": "Somente AD/LDAP", "en": "AD/LDAP only", "es": "Solo AD/LDAP"},
    "set.ldap_mode_both": {"pt": "Local + AD/LDAP", "en": "Local + AD/LDAP", "es": "Local + AD/LDAP"},
    "set.ldap_server": {"pt": "Servidor", "en": "Server", "es": "Servidor"},
    "set.ldap_domain": {"pt": "Domínio", "en": "Domain", "es": "Dominio"},
    "set.ldap_base_dn": {"pt": "Base DN", "en": "Base DN", "es": "Base DN"},
    "set.ldap_user_attr": {"pt": "Atributo do usuário", "en": "User attribute", "es": "Atributo de usuario"},
    "set.ldap_bind_dn": {"pt": "Bind DN (conta de serviço)", "en": "Bind DN (service account)", "es": "Bind DN (cuenta de servicio)"},
    ...
    "set.ldap_test_user": {"pt": "Usuário AD", "en": "AD user", "es": "Usuario AD"},
    "set.ldap_test_pass": {"pt": "Senha", "en": "Password", "es": "Contraseña"},
    "set.smtp_title": {"pt": "E-mail (SMTP)", "en": "Email (SMTP)", "es": "Correo (SMTP)"},
    "set.smtp_hint": {"pt": "Envio de e-mails nos eventos: execução criada, aguardando aprovação, aprovada/rejeitada e concluída. Vazio = desligado.", "en": "Sends emails on events: run created, pending approval, approved/rejected and finished. Empty = off.", "es": "Envía correos en eventos: ejecución creada, pendiente de aprobación, aprobada/rechazada y finalizada. Vacío = apagado."},
    "set.smtp_host": {"pt": "Servidor SMTP", "en": "SMTP server", "es": "Servidor SMTP"},
    "set.smtp_port": {"pt": "Porta", "en": "Port", "es": "Puerto"},
    "set.smtp_user": {"pt": "Usuário", "en": "User", "es": "Usuario"},
    "set.smtp_password": {"pt": "Senha", "en": "Password", "es": "Contraseña"},
    "set.smtp_from": {"pt": "Remetente (From)", "en": "Sender (From)", "es": "Remitente (From)"},
    "set.smtp_tls": {"pt": "STARTTLS (587)", "en": "STARTTLS (587)", "es": "STARTTLS (587)"},
    "set.smtp_ssl": {"pt": "SSL/SMTPS (465)", "en": "SSL/SMTPS (465)", "es": "SSL/SMTPS (465)"},
    "set.smtp_save": {"pt": "Salvar SMTP", "en": "Save SMTP", "es": "Guardar SMTP"},
    "set.smtp_test": {"pt": "Enviar teste", "en": "Send test", "es": "Enviar prueba"},
    "set.smtp_test_to": {"pt": "Destinatário do teste", "en": "Test recipient", "es": "Destinatario de prueba"},
    ...
    # --- backup via rConfig (fonte oficial de backup) ---
    "bk.source_rconfig": {"pt": "Fonte: rConfig", "en": "Source: rConfig", "es": "Fuente: rConfig"},
    "bk.backup_now": {"pt": "Backup agora", "en": "Backup now", "es": "Backup ahora"},
    "bk.backup_all": {"pt": "Backup de todos", "en": "Backup all", "es": "Backup de todos"},
    "bk.run_started": {"pt": "Backup solicitado ao rConfig (executa em segundo plano lá).", "en": "Backup requested to rConfig (runs in background there).", "es": "Backup solicitado a rConfig (se ejecuta en segundo plano allí)."},
    "bk.not_configured": {"pt": "rConfig não configurado — ver Configurações → Conexões de API.", "en": "rConfig not configured — see Settings → API connections.", "es": "rConfig no configurado — ver Configuración → Conexiones de API."},
    "bk.rconfig_summary": {"pt": "rConfig: {total} device(s) · sucesso: {ok} · falha: {fail} · nunca: {never} · última execução: {last}", "en": "rConfig: {total} device(s) · success: {ok} · failed: {fail} · never: {never} · last run: {last}", "es": "rConfig: {total} dispositivo(s) · éxito: {ok} · fallo: {fail} · nunca: {never} · última ejecución: {last}"},
    "bk.rconfig_summary_empty": {"pt": "rConfig sem dados de resumo.", "en": "rConfig has no summary data.", "es": "rConfig sin datos de resumen."},
    "bk.no_backup": {"pt": "Sem backup no rConfig para este device.", "en": "No backup in rConfig for this device.", "es": "Sin backup en rConfig para este dispositivo."},
    "bk.versions_rconfig": {"pt": "Versões (rConfig)", "en": "Versions (rConfig)", "es": "Versiones (rConfig)"},
    "bk.diff_rconfig": {"pt": "Diff (rConfig, última vs. anterior)", "en": "Diff (rConfig, latest vs previous)", "es": "Diff (rConfig, última vs anterior)"},
    "bk.not_linked": {"pt": "Device não vinculado ao rConfig (IP não encontrado no rConfig).", "en": "Device not linked to rConfig (IP not found in rConfig).", "es": "Dispositivo no vinculado a rConfig (IP no encontrado en rConfig)."},
    "bk.download": {"pt": "baixar", "en": "download", "es": "descargar"},
    "bk.view_content": {"pt": "Ver conteúdo", "en": "View content", "es": "Ver contenido"},
    "bk.content": {"pt": "Conteúdo da config", "en": "Config content", "es": "Contenido de la config"},
    "bk.trigger_failed": {"pt": "Falha ao solicitar o backup ao rConfig.", "en": "Failed to request backup from rConfig.", "es": "Fallo al solicitar el backup a rConfig."},
    ...
    "nav.parameters": {"pt": "Parâmetros", "en": "Parameters", "es": "Parámetros"},
    ...
    "msg.token_created": {"pt": "Token criado. Copie-o agora!", "en": "Token created. Copy it now!", "es": "Token creado. ¡Cópielo ahora!"},
